      ...
      <div className="max-w-xs mx-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="text-white flex gap-2">
            <button
              className={onActive == 'andamento' ? "flex-1 border border-orange-500 bg-orange-500 p-2 rounded hover:bg-orange-600 transition-all font-semibold ring-2 ring-yellow-200 text-yellow-200" : "flex-1 border border-orange-500 bg-orange-500 p-2 rounded hover:bg-orange-600 transition-all font-semibold"}
              onClick={() => setOnActive('andamento')}
            >
              Em andamento
            </button>
            <button
              className={onActive == 'feito' ? "flex-1 border border-green-500 bg-green-500 p-2 rounded hover:bg-green-600 transition-all font-semibold ring-2 ring-yellow-200 text-yellow-200" : "flex-1 border border-green-500 bg-green-500 p-2 rounded hover:bg-green-600 transition-all font-semibold"}
